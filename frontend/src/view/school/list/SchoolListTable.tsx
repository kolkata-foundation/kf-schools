          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'address'}
                label={i18n(
                  'entities.school.fields.address',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'contactPhone'}
                label={i18n(
                  'entities.school.fields.contactPhone',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'contactEmail'}
                label={i18n(
                  'entities.school.fields.contactEmail',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'principalsName'}
                label={i18n(
                  'entities.school.fields.principalsName',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                label={i18n(
                  'entities.school.fields.principalsEmail',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                label={i18n(
                  'entities.school.fields.principalsPhone',
                )}
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>{row.principalsName}</TableCell>
                <TableCell>{row.principalsEmail}</TableCell>
                <TableCell>{row.principalsPhone}</TableCell>                  
                  <TableCell>
                    <Box
                      display="flex"
