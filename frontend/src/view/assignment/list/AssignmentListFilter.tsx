...
const schema = yup.object().shape({
  ...
  dueDateRange: yupFilterSchemas.dateRange(
    i18n('entities.assignment.fields.dueDateRange'),
  ),
...
const previewRenders = {
  ...
  category: {
    ...
    render: filterRenders.enumerator('entities.assignment.enumerators.category',),
  },
  dueDateRange: {
    label: i18n('entities.assignment.fields.dueDateRange'),
