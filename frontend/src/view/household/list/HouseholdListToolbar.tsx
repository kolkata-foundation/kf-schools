...
function HouseholdToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    householdSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    householdSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=household"
...
export default HouseholdToolbar;
