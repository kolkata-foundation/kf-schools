          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'familyLastName'}
                label={i18n(
                  'entities.household.fields.familyLastName',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
              ...
              <TableCellCustom
                ...
                name={'zipcode'}
                label={i18n(
                  'entities.household.fields.zipcode',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                label={i18n(
                  'entities.household.fields.primaryGuardianFullName',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                label={i18n(
                  'entities.household.fields.primaryGuardianCellPhone',
                )}
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>{row.familyLastName}</TableCell>
                <TableCell>{row.address}</TableCell>
                <TableCell>{row.zipcode}</TableCell>
                <TableCell>{row.primaryGuardianFullName}</TableCell>
                <TableCell>{row.primaryGuardianCellPhone}</TableCell>                  
                  <TableCell>
                    <Box
                      display="flex"
