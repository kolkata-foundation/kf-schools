          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'rollNumber'}
                label={i18n(
                  'entities.student.fields.rollNumber',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'fullName'}
                label={i18n(
                  'entities.student.fields.fullName',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.student.fields.school',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'gender'}
                label={i18n(
                  'entities.student.fields.gender',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'dateOfBirth'}
                label={i18n(
                  'entities.student.fields.dateOfBirth',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.student.fields.household',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.student.fields.currentSection',
                )}
              />              
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  {row.gender
                    ? i18n(
                        `entities.student.enumerators.gender.${row.gender}`,
                      )
                    : null}
                </TableCell>
                ...
                <TableCell>
                  <SectionListItem value={row.currentSection} />
                </TableCell>                  
                  <TableCell>
                    <Box
                      display="flex"
