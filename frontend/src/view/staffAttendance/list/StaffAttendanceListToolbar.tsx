...
function StaffAttendanceToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    staffAttendanceSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    staffAttendanceSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=staffAttendance"
...
export default StaffAttendanceToolbar;
