...
const schema = yup.object().shape({
  ...
  academicYear: yupFilterSchemas.enumerator(
...
const previewRenders = {
  ...
  academicYear: {
    ...
    render: filterRenders.enumerator('entities.enrollment.enumerators.academicYear',),
  },
}

function EnrollmentListFilter(props) {
...
export default EnrollmentListFilter;