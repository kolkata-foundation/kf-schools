...
function StudentDocListTable(props) {
  const [
    recordIdToDestroy,
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.studentDoc.fields.student',
                )}
              />
              <TableCellCustom
                label={i18n(
              ...
              <TableCellCustom
                ...
                name={'docName'}
                label={i18n(
                  'entities.studentDoc.fields.docName',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'comment'}
                label={i18n(
                  'entities.studentDoc.fields.comment',
                )}
              />              
...
export default StudentDocListTable;
