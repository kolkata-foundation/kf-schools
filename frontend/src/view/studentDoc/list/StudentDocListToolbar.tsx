...
function StudentDocToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    studentDocSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    studentDocSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=studentDoc"
...
export default StudentDocToolbar;
